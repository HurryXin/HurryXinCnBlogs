if (initCheck()) {
    ...
    window.cnblogsConfigDefault = {
        GhUserName: 'HurryXin',
        GhRepositories: 'HurryXinCnBlogs',
        GhVersions: 'v1.2.3',
        CnVersions: "",
        blogUser: "",
        blogAvatar: "",
        ...
        menuNavList: [],
        menuUserInfoBgImg: '',
        webpageTitleOnblur: "( • ̀ω•́ )✧",
        webpageTitleOnblurTimeOut: 500,
        webpageTitleFocus: "(づ｡◕ᴗᴗ◕｡)づ",
        ...
        homeTopImg: [
            "https://cdn.jsdelivr.net/gh/HurryXin/HurryXinCnBlogs@master/img/wallhaven-47ldq9.webp"
        ],
        homeBannerText: "",
        homeBannerTextType: "jinrishici",
        essayTopImg: [
            "https://cdn.jsdelivr.net/gh/HurryXin/HurryXinCnBlogs@master/img/wallhaven-96w8e8.webp"
        ],
...
function getVersionConfig() {
    ...
    } else if(window.cnblogsConfig.GhUserName === 'HurryXin') {
        window.themeVersion = [
            [
                "v1.1.6",
